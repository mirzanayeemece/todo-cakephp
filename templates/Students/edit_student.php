	...
	<div class="panel-body">
		...
		?>		
	      <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" value="<?= $student->name ?>" required class="form-control" id="name" name="name" placeholder="Enter Name">
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="email">Email:</label>
		    <div class="col-sm-10">
		      <input type="email" value="<?= $student->email ?>" required class="form-control" name="email" id="email" placeholder="Enter email">
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2">Phone no:</label>
		    <div class="col-sm-10">
		      <input type="text" value="<?= $student->phone_no ?>" required class="form-control" id="phone_no" name="phone_no" placeholder="Enter Phone no">
		    </div>
		  </div>
		  <div class="form-group">
